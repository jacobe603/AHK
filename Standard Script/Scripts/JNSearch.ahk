...
;Ini File for RC Menu Variable Transfer
    ComINIPath=..Project Search v4\Data\Search.ini
    ScriptPath=..Project Search v4\Scripts\rc.ahk
...
jobnumber := A_Args[1]
	...
	IfExist, %fullpath%   ; If the file exists and has a path, open the file directory
                    ...
                    IniWrite,%jobnumber%,%ComINIPath%,CurrentProject,JobNumber
                    IniWrite,%jobName%,%ComINIPath%,CurrentProject,JobName

	run %A_WorkingDir%\..\Project Search v4\Scripts\rc.ahk
