...
;Run in UIA mode so we can interact with Edge and Ecat
...
~RButton & a::SnapActiveWindow("top","left","full")
^!Numpad4::SnapActiveWindow("top","left","full")
^!Numpad6::SnapActiveWindow("top","right","full")
~RButton & f::SnapActiveWindow("top","right","full")
Return

^!Numpad5::
WinGet, active_id, ID, A
WinGet, WinState, MinMax, ahk_id %active_id%
If WinState = 0
