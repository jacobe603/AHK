...
Gui, Add, Text, x20 y93 w57, Line 1
Gui, Add, Text, x20 y141 w57, Line 2
Gui, Add, Text, x20 y189 w57, Line 3
...
subtotal := lnTotalPrice1+lnTotalPrice2+lnTotalPrice3
...
MsgBox, Total number of lines in the file "orders.csv" :`n%lines%

FilledForm := OrdersFolder "\SVL PO " poNumber " " lines ".pdf"
;msgBox, % FilledForm
...
FileAppend, %poNumber%`,%mfgPOname%`,%shipToName%`,%address1%`,%address2%`,%city%`,%state%`,%zip%`,%ContactName%`,%ContactNum%`,%lnQty1%`,%lnDesc1%`,%lnUnitPrice1%`,%lnTotalPrice1%`,%lnQty2%`,%lnDesc2%`,%lnUnitPrice2%`,%lnTotalPrice2%`,%lnQty3%`,%lnDesc3%`,%lnUnitPrice3%`,%lnTotalPrice3%`,%subTotal%`,%multi%`,%freight%`,%grandTotal%`,%poDate%`,POGUI`,`n,%OrdersFolderPath%\orders.csv
